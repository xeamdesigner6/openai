      ...
      <section className="bg-[#e6e6e6] h-full  mx-auto p-5 sm:p-10 md:px-6 py-5  ">
        <div className='container mx-auto'>
          <div className='flex  justify-between items-center mb-3  '>
            <p className="text-center text-[#1c4f78] "><a href="/" title="home">Dashboard &gt; </a><a href="/aboutus" title="about">Salary Negotation Success  &gt; </a><a href="/aboutus" title="about">Real Time Interaction </a></p>
            ...
            <div className='flex items-center gap-5'>
              ...
              <div className="flex flex-col items-center justify-center gap-5  md:flex-row py-3"><a
                ...
                <a className="inline-block w-auto text-center min-w-[200px] px-3 py-1 text-white transition-all bg-gray-700 dark:bg-[#ff5252] dark:text-white rounded-md shadow-xl sm:w-auto  hover:text-white shadow-neutral-300  hover:shadow-2xl hover:shadow-neutral-400 hover:-tranneutral-y-px"
                  href="">End The Session
                </a>
              </div>
            </div>
                  ...
                  {botChat ? (
                    ...
                    chats.map((message, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className={`flex ${isTestUserMessage ? "justify-end" : "justify-start"} items-center`}
                        >
                          {isTestUserMessage ? (
                            <>
                              <div className="w-1/2 bg-[#2196f3] border border-1 border-zinc-300 border-opacity-30 rounded-md flex items-center px-2 py-2 text-white relative">
                              ...
                              <img
                                src={message.avatarUrl || "https://www.tailwind-kit.com/images/object/10.png"}
